...
class SubcategoryController extends Controller
{
    ...
    public function actionList($categoryId=NULL)
    {
        ...
        if($categoryId != NULL){$category = ['category_id' => $categoryId];}else{$category = NULL;}
        $subcategory = Yii::$app->field_generator->genArrayList($modelSubCategory,'id','name',$category);
